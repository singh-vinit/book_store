...
const App = () => {
  return (
    <>
      <div className="py-2 sticky top-0 z-10 bg-white/50 backdrop-blur-md flex items-center justify-center gap-2 border-b">
        <svg
        ...
        <span className="font-medium text-xl">Bookshelf</span>
      </div>
